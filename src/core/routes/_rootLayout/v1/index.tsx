          ...
          <Card className={profileStyles.card}>
              ...
              <div className={profileStyles.container}>
                <Card.Content className={profileStyles.content}>
                  <Theme.Text variant="headline" size="large">Aarón Cervantes</Theme.Text>
                  <Theme.Text variant="title">Senior Frontend Engineer</Theme.Text>
                </Card.Content>
                <Card.Footer className={profileStyles.footer}>
                  <Theme.Text variant="title" size="small">Linkedin</Theme.Text>
                  <Theme.Text variant="title" size="small">Github</Theme.Text>
                </Card.Footer>
              </div>
          </Card>
        </section>
